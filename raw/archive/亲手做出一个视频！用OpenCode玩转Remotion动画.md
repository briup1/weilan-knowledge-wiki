---
title: "亲手做出一个视频！用OpenCode玩转Remotion动画"
source: "https://mp.weixin.qq.com/s/_QhtdSSR7OlAoRc1SFPT5A"
author:
  - "[[BBSS1841]]"
published:
created: 2026-04-17
description: "你有没有这种感觉？看到别人做的酷炫视频，很羡慕但自己不会 Pr、AE、Final Cut请人做，又要花钱好消息：现在你也可以用 AI 做视频了！"
tags:
  - "clippings"
---
BBSS1841 *2026年4月3日 10:41*

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/kIVrzIXpYnUmXYDibdXJ2sPv3AAibnl1NK0WP0D65FLjMiahXeRc60e5qXeRv40noNoC6cLiacOVeJG1Z06u6ptRDdNnaCYXQNcLicbabrENT2ts/640?wx_fmt=png&from=appmsg&watermark=1&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=0)

你有没有这种感觉？

- 看到别人做的酷炫视频，很羡慕
- 但自己不会 Pr、AE、Final Cut
- 请人做，又要花钱

**好消息：现在你也可以用 AI 做视频了！**

就像以前拍照要用 Photoshop，现在手机一键就能出片。

**这期，我就带你用 OpenCode + Remotion，亲手做一个视频出来！**
...
**你可以理解为：用写代码的方式，做出了一个视频。别看到“代码”两个字就发怵！继续往下看！**

### 为什么我要学这个？

| 对比 | 传统方式 | Remotion 方式 |
| --- | --- | --- |
| 学习难度 | 高（要学 AE/Pr） | 低（会说话就行） |
| 修改方便 | 麻烦 | 改句话就行 |
| 成本 | 付费软件/请人 | 免费 |
| 效果 | 专业 | 足够日常使用 |
...
OpenCode 会自动帮你安装好，过程中有什么问题也会告诉你。
...
> "帮我做一个微信表情包，时长 3 秒，背景是黄色，上面有一个大笑的表情图标从左边弹出来，下面写着「太牛了」三个字，带一点弹跳效果"
...
<video src="https://mpvideo.qpic.cn/0b2ehaasmaabraaeeewpcjuvcogdey4acjqa.f10002.mp4?dis_k=a39a3525d7e5c53d45efddc5f2be4fd1&amp;dis_t=1776422972&amp;play_scene=10120&amp;auth_info=cMfBj8MNbjFu4u333Q4MUT1Ze2RlQh5mNRQwMGFIMTMeYhxdcW8dB0x7dTIOORpGaQtxZDlLTn9dY2spORJnMFcyAlc=&amp;auth_key=de43fcee8e2f56fa98cc339062eb6955&amp;vid=wxv_4455048797836214275&amp;format_id=10002&amp;support_redirect=0&amp;mmversion=false" controls="">您的浏览器不支持 video 标签</video>

---

## 实战2：做一个 OpenCode 介绍视频

### 场景

你想向朋友介绍 OpenCode，但说不清楚？
...
> "帮我做一个 20 秒的 OpenCode 介绍视频。开头是一个笔记本电脑从屏幕中间弹出，带一点弹性效果。然后文字从下方淡入，写着「OpenCode：你的 AI 助手」。然后下一行显示「会说话就能用」
...
**不需要会动画设计，告诉 AI 你想表达什么就行！**

<video src="https://mpvideo.qpic.cn/0bc3oudvcaahyuadm3wja5uvo5odkf2qouia.f10002.mp4?dis_k=5eab84d9e9a1752d0ac85a63e7a03116&amp;dis_t=1776422972&amp;play_scene=10120&amp;auth_info=d7mX4dxbNjJl47v73AAIVWlZemRhFhg4ZBFlNmJNMmYZNUlaJTlFBEd6Iz4PNx5CPQtwZD0fSCEMZj4vOhdkZVBlV1A=&amp;auth_key=bd9bc3a593f3ab6a08b4d99d0ecffcea&amp;vid=wxv_4455061683358138368&amp;format_id=10002&amp;support_redirect=0&amp;mmversion=false" controls="">您的浏览器不支持 video 标签</video>
...
> "帮我做一个 Instagram 帖子，背景是渐变色，中间有「今日分享」四个字，带一点闪烁效果"

### 2\. 简单的科普视频

> "帮我做一个 30 秒的科普视频，标题是『什么是AI』，中间有文字逐行出现，背景是蓝色渐变"

### 3\. 数据可视化

> "帮我做一个 15 秒的图表动画，柱状图从下往上增长，标题是『2024年销量增长』"

### 4\. 个人品牌片头

> "帮我做一个 5 秒的片头，背景是黑色，中间是我的名字，带一点光晕效果"
...
**Q：我需要会写代码吗？** A：不需要！你只需要告诉 OpenCode 你想要什么，它帮你写代码。

**Q：视频多长时间合适？** A：微信贴图 3-5 秒，介绍视频 15-30 秒，社交媒体推荐 30-60 秒。

**Q：生成的视频在哪里？** A：OpenCode 会告诉你文件位置，你可以直接分享到微信。

**Q：收费吗？** A：Remotion 本身免费，但渲染可能消耗一些算力。

**Q：不会描述想要的视频怎么办？** A：就直接告诉 OpenCode 你的用途和场景，比如"我想做一个生日祝福视频"，它会帮你设计！
...
- 什么是 Remotion
- 如何安装技能
- 3 个实战案例（微信贴图、OpenCode 介绍、Claude Code 介绍）
- 更多常见用法

**现在，你也可以做出自己的视频了！**

不需要学复杂的软件，不需要请人，只需要告诉 AI 你想要什么。

**这就是 AI 时代的"视频自由"！**

---

**下期，我们会讲讲：什么是 TUI？为什么智能体离不开它？**
